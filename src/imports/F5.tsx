import svgPaths from "./svg-fngzbo20sg";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[3.431px] items-center left-[calc(50%-0.5px)] top-[100.09px] translate-x-[-50%]">
      ...
      <div className="bg-[#87868c] h-[3.818px] relative shrink-0 w-[41.998px]">
        <div aria-hidden="true" className="absolute border-[0.479px] border-[rgba(255,255,255,0.1)] border-solid inset-[-0.479px] pointer-events-none" />
      </div>
      <div className="h-[3.818px] relative shrink-0 w-[41.998px]" style={{ backgroundImage: "linear-gradient(90deg, rgba(255, 255, 255, 0.5) 0%, rgba(255, 255, 255, 0.5) 100%), linear-gradient(90deg, rgb(37, 39, 45) 0%, rgb(37, 39, 45) 100%)" }}>
        <div aria-hidden="true" className="absolute border-[0.479px] border-[rgba(255,255,255,0.1)] border-solid inset-[-0.479px] pointer-events-none" />
...
function Frame2() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-1/2 px-[8px] py-[4px] top-[224px] translate-x-[-50%]">
...
export default function F() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="F5">
      ...
      <Frame />
      <Cancel />
      <div className="absolute h-[249.369px] left-[calc(50%+0.5px)] top-[308px] translate-x-[-50%] w-[240px]" data-name="Gemini_Generated_Image_v58jeav58jeav58j 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <p className="absolute font-['Proxima_Nova:Bold',sans-serif] leading-[16px] left-1/2 not-italic text-[18px] text-center text-white top-[192px] translate-x-[-50%] whitespace-pre">You’re the</p>
      <Frame2 />
      <p className="absolute font-['Proxima_Nova:Regular',sans-serif] leading-[1.33] left-[197px] not-italic text-[#ccc] text-[18px] text-center top-[605px] translate-x-[-50%] w-[258px] whitespace-pre-wrap">
        <span>{`You finished the first season of Succession in just `}</span>
        <span className="font-['Proxima_Nova:Bold',sans-serif]">3</span>
        <span>{` days `}</span>
      </p>
      <p className="absolute font-['Proxima_Nova:Regular',sans-serif] leading-[1.33] left-[197px] not-italic text-[#ccc] text-[18px] text-center top-[677px] translate-x-[-50%] w-[258px] whitespace-pre-wrap">No days off in the Roy family</p>
